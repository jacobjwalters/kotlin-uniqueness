...
\begin{bnf}
  P ::=
    ...
    ;;
  M ::=
    | $m(\overline{x : \tau}) : \sigma \{ \Begin \Semi s \Semi \Return \, e \}$  : Method Definitions
    | $m(\overline{x : \tau}) : \sigma$  : Method Declarations
    ;;
  $\tau$, $\sigma$ ::=
    | $\Nat$ : Naturals
    | $\Bool$ : Booleans
...
\begin{mathpar}
  ...
  \ir{IfStmt}{\Gamma \vdash e : \Bool \\ \Gamma \vdash s_1 \dashv \Gamma' \\ \Gamma \vdash s_2 \dashv \Gamma'}{\Gamma \vdash{} \If e \Then s_1 \Else s_2 \dashv \Gamma'}

  \ir{Return}{\drop(\Gamma) = \Gamma', \square_\tau \\ \Gamma \vdash e : \tau}{\Gamma \vdash{} \Return e \dashv \Gamma'}

  \ir{CallStmt}{m : (\tau_1, \tau_2, ...): \sigma \\ \Gamma \vdash e_1 : \tau_1 \\ \Gamma \vdash e_2 : \tau_2 \\ \dots}{\Gamma \vdash m(e_1, e_2, ...) \dashv \Gamma}
\end{mathpar}
